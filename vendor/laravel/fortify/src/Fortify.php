...
class Fortify
{
    ...
    {
        static::loginView('backend.admin.login');
        static::twoFactorChallengeView($prefix.'two-factor-challenge');
        static::registerView('backend.admin.register');
        static::requestPasswordResetLinkView('backend.admin.forgot-password');
        static::resetPasswordView('backend.admin.reset-password');
        static::verifyEmailView('backend.admin.verify-email');
