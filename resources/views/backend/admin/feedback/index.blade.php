        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Manage Client Feedback</h3>
                </div>
                <div class="card-body">
                    <a href="{{ route('admin.add_feedback') }}" class="btn btn-success btn-sm mb-3" title="Add New">
                                    ...
                                    <tr>
                                        ...
                                        <td name="bstable-actions">
                                            <div class="btn-list d-flex justify-content-center" style="gap: 10px;">
                                                <a href="{{ route('admin.edit_feedback', $item->id) }}"><button
                                                        class="btn btn-primary btn-sm" data-bs-toggle="tooltip"
                                                        data-bs-original-title="Edit"><span class="fe fe-edit fs-14"></span>
                                                    </button></a>
                                                <form action="{{ route('admin.delete_feedback') }}" method="post"
                                                    id="delete">
                                                    @csrf
